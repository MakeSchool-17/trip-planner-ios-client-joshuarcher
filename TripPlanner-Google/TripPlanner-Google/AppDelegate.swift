...
/*  This was moved to the CoreDataStack.swift file, not sure if everything's settled yet so I left it 10/29
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "Scope.TripPlanner_Google" in the application's documents Application Support directory.
